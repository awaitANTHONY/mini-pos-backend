(function ($) {
  $(document).on('ready', function () {
    ...
    $('.u-sidebar-inner nav li a').each(function () {
      if ($(this).attr('href') == window.location.href) {
        $(".u-sidebar-nav-menu__link").removeClass('active')
        $(this).addClass('active');
        $(this).parent().parent().closest('.u-sidebar-nav-menu__item').addClass('u-sidebar-nav--opened');
      }
    });
  });
})(jQuery);