			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						...
						<div class="field-group params-card mx-4 my-2 row" style="width: 100%;" data-key="0"> 
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control select2 source_type" name="source_type[]" data-selected="streaming_url">
										<option value="streaming_url">{{ _lang('Streaming Url') }}</option>
										<option value="youtube">{{ _lang('Youtube') }}</option>
									</select>
								</div>
							</div>
							<div class="col-md-6 streaming_url">
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control select2" name="source_status[]" data-selected="{{ old('status', 1) }}">
										<option value="1">{{ _lang("Active") }}</option>
										<option value="0">{{ _lang("In-Active") }}</option>
									</select>
								</div>
							...
							<div class="col-md-6 streaming">
								<div class="form-group">
									...
									<select class="form-control select2 source_from" name="source_from[]" data-selected="unrestricted">
